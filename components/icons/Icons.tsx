...
export const BrainCircuit: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a5.5 5.5 0 0 0-5.5 5.5c0 1.3.4 2.5 1.2 3.5-.2 1.3-.8 2.5-1.7 3.5A5.5 5.5 0 0 0 12 22a5.5 5.5 0 0 0 5.5-5.5c0-1.3-.4-2.5-1.2-3.5.2-1.3.8-2.5 1.7-3.5A5.5 5.5 0 0 0 12 2z"></path><path d="M12 14a2.5 2.5 0 0 0-2.5 2.5c0 1.5-1.2 2.5-2.5 2.5"></path><path d="M12 14a2.5 2.5 0 0 1 2.5 2.5c0 1.5 1.2 2.5 2.5 2.5"></path><path d="M12 12a2.5 2.5 0 0 0-2.5-2.5c0-1.5-1.2-2.5-2.5-2.5"></path><path d="M12 12a2.5 2.5 0 0 1 2.5-2.5c0-1.5 1.2-2.5 2.5-2.5"></path><circle cx="12" cy="12" r="2.5"></circle></svg>
);
...
export const Dashboard: React.FC<IconProps> = ({ className }) => (
